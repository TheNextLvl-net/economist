...
public class BalanceCommand {
    public static LiteralCommandNode<CommandSourceStack> create(final EconomistPlugin plugin) {
        return Commands.literal("balance")
                ...
                .executes(context -> {
                    ...
                    if (sender instanceof final Player player) return balance(context, player, null, plugin);
    ...
    private static int balance(final CommandContext<CommandSourceStack> context, final OfflinePlayer player, @Nullable final World world, final EconomistPlugin plugin) {
        final var sender = context.getSource().getSender();
