...
public class ServiceEconomyController implements EconomyController {
    ...
    public ServiceEconomyController(@Nullable final ServiceBankController bankController, final EconomistPlugin plugin) {
        this.bankController = bankController;
        this.plugin = plugin;
    }

    public void register() {
        final var services = plugin.getServer().getServicesManager();
    ...
    @Override
    public CompletableFuture<Account> createAccount(final UUID uuid) throws IllegalStateException {
        return economyController().createAccount(uuid).thenApply(ServiceAccount::new);
    }

    @Override
    public CompletableFuture<Account> createAccount(final UUID uuid, final World world) throws IllegalStateException {
